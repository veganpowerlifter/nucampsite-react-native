...
const ReservationScreen = () => {
    const [campers, setCampers] = useState(1); // one variable for each input
 ...
 //   const [showModal, setShowModal] = useState(false);
    ...
    const handleReservation = () => { //added lines 20-37 and commented out 41.
        const message = `Number of Campers: ${campers}
\nHike-In ? ${hikeIn}
\nDate: ${date.toLocateDateString('en-US')}`;
        Alert.alert(
            'Begin Search?',
                message,
                [
...
// setShowModal(!showModal); // why did we remove this in workshop 3?
    };
